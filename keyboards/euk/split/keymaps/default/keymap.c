...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */                                           
    ...
    [_QWERTY] = LAYOUT(
      ...
      KC_NUBS , KC_Z    ,  KC_X   ,  KC_C  ,  KC_V  ,  KC_B ,                                           KC_N  ,  KC_M  ,  KC_COMM , KC_DOT  , KC_SLSH  ,  KC_RBRC ,         
      KC_LCTL , KC_LGUI ,  KC_LALT,  MO(2) ,  MO(1) ,                                                           KC_ENT ,  KC_RGUI , KC_RALT , KC_HOME  ,  KC_DEL  ,
                                                            _______ , KC_RIGHT,       KC_UP   , _______,                     
                                                            KC_SPC  , KC_LEFT ,       KC_DOWN , KC_SPC
    ),
    ...
    */                                           
    ...
    [_UTIL] = LAYOUT(
      ...
      _______ , _______ , _______ , _______ , _______ , _______ ,                                            _______ , KC_LEFT , KC_DOWN , KC_RIGHT, KC_QUOT , KC_NUHS,         
